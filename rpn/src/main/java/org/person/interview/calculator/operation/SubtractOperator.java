...
public class SubtractOperator extends AbstractOperationItem {

    public SubtractOperator(ExpressionItem item){
        super(item);
    }
    ...
    protected Operand doExecute(List<Operand> operands) {
        ...
        Operand result = operationItemFactory.createOperand(b1.subtract(b2));
        return result;
    }
